<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Link\edit.html";i:1544515827;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;s:82:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\js.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="url" type="text" class="form-control" name="url"  value="<?php echo $info['url']; ?>" required aria-required="true">
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="content" type="text" class="form-control" name="memo" value="<?php echo $info['memo']; ?>" required aria-required="true">
                            </div>
                        </div>
...
<script>
    require(['app','editor','qiniuUploader', 'link/edit'],function (app, editor,qiniuUploader, create){
