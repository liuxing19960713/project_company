                        ...
                        <div class="form-group" id="tags">
                            ...
                            <div class="input-group col-sm-7" style="padding-top:6px;">
                                <label style="margin-right:15px;">
                                     ...
                                     <input type="checkbox" id="check1" value="<?php echo $vv['id']; ?>" name="label_id[]" class="check"><?php echo $vv['title']; endforeach; endif; else: echo "" ;endif; ?>
                                </label>
