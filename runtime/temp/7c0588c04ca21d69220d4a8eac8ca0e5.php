<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\About\index.html";i:1544497201;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    function Alter(dom) {
        var id = $(dom).attr("class");
        window.location.href = "/admin/about/redact?id=" + id;
    }
</script>
</html>