<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\about\redact.html";i:1544522454;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;s:82:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\js.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7" id="editor-container">
                                <textarea name="content"  id="content" style="height:500px;"><?php echo $info['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    require(['app','editor','qiniuUploader', 'about/edit'],function (app, editor,qiniuUploader, create){
