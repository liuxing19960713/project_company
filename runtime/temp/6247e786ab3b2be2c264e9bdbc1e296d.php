<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Link\create.html";i:1544515352;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;s:82:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\js.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="content" type="text" class="form-control" name="memo" required aria-required="true">
                            </div>
                        </div>
...
<script>
    require(['app','editor','qiniuUploader', 'link/create'],function (app, editor,qiniuUploader, create){
