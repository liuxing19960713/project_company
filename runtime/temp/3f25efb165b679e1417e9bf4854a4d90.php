<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Label\alert.html";i:1544667564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="DoctorData clearfix">
        ...
        <div class="Inf Box clearfix">
            <div class="Box2" style="width: 25%">
                <h5 class="h5">标签名：</h5>
                <input type="text" style="width: 90%" name="title" value="<?php echo $info['title']; ?>" placeholder="标签名：">
            </div>

            <div class="Box2" style="width: 70%">
                <h5 class="h5">标签链接：</h5>
                <input type="text" style="width: 90%" name="label_url" value="<?php echo $info['label_url']; ?>" placeholder="标签链接：">
            </div>
        ...
        <div class="ConFee Box clearfix">
            <div class="Box2" style="width: 100%">
                ...
                <select name="is_reco" id="is_open_image" style="width: 24%">
                        <option value="1" 
                            <?php if($info['is_reco'] == '1'): ?>
                                selected
                            <?php endif; ?>
                        >是</option>
                        <option value="0" 
                            <?php if($info['is_reco'] == '0'): ?>
                                selected
                            <?php endif; ?>
                        >否</option>
                </select>
             ...
             <div class="Box2" style="width: 100%">
                ...
                <select name="is_url" id="is_open_image" style="width: 24%">
                        <option value="1" 
                            <?php if($info['is_url'] == '1'): ?>
                                selected
                            <?php endif; ?>
                        >是</option>
                        <option value="0" 
                            <?php if($info['is_url'] == '0'): ?>
                                selected
                            <?php endif; ?>
                        >否</option>
                </select>
