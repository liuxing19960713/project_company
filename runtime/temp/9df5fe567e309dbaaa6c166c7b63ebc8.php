<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Label\create.html";i:1544664563;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;s:82:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\js.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">是否添加文章快速链接：</label>
                            <div class="input-group col-sm-3">
                                <select class="js_top form-control" name="is_url" id="is_url">
                                    <option value="0" selected>请选择</option>
                                     <option value="0" >否</option>
                                     <option value="1">是</option>
                                </select>
...
<script>
    require(['app','editor','qiniuUploader', 'label/create'],function (app, editor,qiniuUploader, create){
