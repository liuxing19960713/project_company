<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Advert\create.html";i:1544681259;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;s:82:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\js.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">广告图名：</label>
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="ad_name" required aria-required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            <label class="col-sm-3 control-label">请选择栏目</label>
                            <div class="input-group col-sm-3">
                                <select class="js_top form-control" name="colum_id" id="colum_id">
...
<script>
    require(['app','editor','qiniuUploader', 'advert/create'],function (app, editor,qiniuUploader, create){
