<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\carousel\alert.html";i:1544608951;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="DoctorData clearfix">
        ...
        <div class="Inf Box clearfix">
            ...
            <div class="Box2" style="width: 25%">
                <h5 class="h5">名称:</h5>
                    <input type="text" style="width: 90%" name="title" value="<?php echo $DoctorData['title']; ?>" placeholder="logo名称:">
            </div>
        </div>
