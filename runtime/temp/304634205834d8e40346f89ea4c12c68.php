<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Logo\create.html";i:1544601279;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;s:82:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\js.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">logo名：</label>
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="logo_name" required aria-required="true">
                            </div>
                        </div>
...
<script>
    require(['app','editor','qiniuUploader', 'logo/create'],function (app, editor,qiniuUploader, create){
