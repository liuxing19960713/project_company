<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Article\read.html";i:1544756408;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <table id="DoctorTab" border="1">
        ...
        <tr>
            ...
            <td><?php echo $vo['shown']; ?></td>
            <td><?php echo $vo['iscom']; ?></td>
