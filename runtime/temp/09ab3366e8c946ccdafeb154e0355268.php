<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\Cdoctor\edit.html";i:1544583466;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body style="background-color: #f3f3f4">
    <div class="DoctorData clearfix">
        ...
        <div class="Inf Box clearfix">
            ...
            <div class="Box2" style="width: 25%">
                <h5 class="h5">医生职称：</h5>
                    <input type="text" style="width: 90%" name="nick_name" value="<?php echo $DoctorData['title']; ?>" placeholder="医生职称：">
            </div>
        </div>
